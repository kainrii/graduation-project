...
const PersonalDetailEdit = ({ info: initialInfo, onCancel, onSubmit }) => {
  const url = 'https://localhost:7049/api/TalentProfiles/personal-details/666ff8d8ec6911a8d76e8648';
  ...
  const displayedNationalities = Object.values(NATIONALITIES)
  .slice(0, 10)
  .map(({ index, name }) => (
    ...
    <Grid container spacing={2} direction="row" sx={{paddingLeft:4}}>
      ...
      <Grid item xs={4}>
        ...
        <Menu
          ...
          PaperProps={{
            style: {
              maxHeight: 200, // Giới hạn chiều cao của menu, bạn có thể thay đổi tối ưu hơn
              width: 250, // Chiều rộng của menu
            },
          }}
        >
