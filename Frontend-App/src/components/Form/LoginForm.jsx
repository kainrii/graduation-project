      ...
      <Container component="main" maxWidth="xs">
        ...
        <Box
          sx={{
            ...
            alignItems: 'center',
            padding: "16px 16px",
            border: "1px solid var(--dark-moderate-blue)",
            borderRadius: "10px"
          }}
        >
          <Avatar sx={{ m: 1, color: "var(--light-grey)",backgroundColor: "var(--dark-moderate-blue)" }}>
            <LockOutlinedIcon />
          </Avatar>
          <Typography component="h1" variant="h5" color="var(--dark-moderate-blue)">
            Sign in
          </Typography>
